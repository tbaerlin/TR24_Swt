...
//	}
	...
	public static interface IKeyAware<T> {
         ...
         * @return
         */
		void onKey(T row, char key, boolean shiftDown, boolean strgDown, int keyCode);

        /**
         * optional kay down
         *
         * @return true if this EVENT should NOT be used any further
         */
		default boolean onKeyDown(T row, char key, int keyCode) { return false; }
	}
